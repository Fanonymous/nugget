    ...
    getDetailById() {
        this.http.post('clockIn/queryInfo', {
            ...
            if (res.code == 0) {
                ...
                if (res.list[0].myClockInList && res.list[0].myClockInList.length) {
                    res.list[0].myClockInList[0].audioAddress && (this.audioUrl = this.baseApi + res.list[0].myClockInList[0].audioAddress || '')
                    res.list[0].myClockInList[0].videoAddress && (this.videUrl = this.baseApi + res.list[0].myClockInList[0].videoAddress || '')
                    this.punchModel.detail = res.list[0].myClockInList[0].detailInfo
                    if (res.list[0].myClockInList[0].pictureAddressList && res.list[0].myClockInList[0].pictureAddressList.length) {
                        let arr = []
                        res.list[0].myClockInList[0].pictureAddressList.forEach(url => {
                            arr.push(this.baseApi + url)
                        })
                        this.imgages = arr
                    }
                }
